...
public class VentanaModeloPruebasLaboratorio extends Ventana {

	private JTextField txtCodigo;
	private JTextField txtNombre;
	private JTable tblPruebas;
	private static final long serialVersionUID = 1L;
	private ModeloPruebasLaboratorio modelo;
	private static VentanaModeloPruebasLaboratorio instancia;
	private JButton btnEliminar;

	public static synchronized VentanaModeloPruebasLaboratorio getInstancia()
			throws ClassNotFoundException, InstantiationException,
			IllegalAccessException, UnsupportedLookAndFeelException,
			SQLException, JDOMException, IOException {
		return instancia == null ? instancia = new VentanaModeloPruebasLaboratorio()
				: instancia;
	}

	private VentanaModeloPruebasLaboratorio() throws ClassNotFoundException,
		...
		modelo = ModeloPruebasLaboratorio.getInstancia();
	...
	public JPanel getContenido() throws ClassNotFoundException, SQLException,
		...
		tblPruebas = new JTable(ModeloPruebasLaboratorio.getInstancia());
		...
		btnAgregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (!"".equals(txtCodigo.getText())
					...
					PruebaLaboratorio prueba = new PruebaLaboratorio(txtCodigo
